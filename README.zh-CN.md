...
CloudMind 是一个开源、serverless-first 的 AI 时代个人知识与上下文基础设施。
...
- 通过 Web UI、REST API 与 MCP tools 暴露一个私有知识与上下文系统
- 作为 retrieval、agent memory 与 context engineering 工作流的可迁移基础设施

## 概览

CloudMind 将 URL、笔记、PDF 以及 AI 产生的内容统一采集到一个知识库中，并通过处理流水线生成：
